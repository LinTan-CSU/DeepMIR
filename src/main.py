...
def train(train_set, train_labels, valid_set, valid_labels, batch_size, learning_rate, weight_decay, epochs)
    start = time.time()
    ...
    valid_dataset = Dataset(valid_set, valid_labels)
...
if __name__ == '__main__':
    train(train_set, train_labels, valid_set, valid_labels, batch_size=64, learning_rate=0.0001, weight_decay=0.004, epochs=100)
